...
class Command(BaseCommand):
    ...
    help = f"This command is added {NAME} elements"

    def add_arguments(self, parser):
        parser.add_argument(
            "--number", default=2, type=int, help=f"How many {NAME} you want create"
        )
    ...
    def handle(self, *args, **options):
        ...
        seeder.execute()
        self.stdout.write(self.style.SUCCESS(f"{review_number} {NAME} creeated !!!"))
